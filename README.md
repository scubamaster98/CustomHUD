...
CustomHUD should work on versions newer than U37.1 just fine. If it doesn't, it's recommended to use the version from the "compat" branch. There are more branches for this mod, made to support other older versions of the game.
